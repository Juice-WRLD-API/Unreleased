...
/** Proposes every staged change, oldest folder-creation first. Each one that
 *  lands is dropped from the queue; failures stay queued carrying the error so
 *  they can be retried without re-dragging everything. */
